...
const BrowseTips = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:3000/tip-info-publics?category=${item}`)
    .then(res => res.json())
    .then(data => {
      setFetchTip(data)
    })
      ...
      <div className="overflow-x-auto">
        <div className="flex justify-start">
          <fieldset className="fieldset">
            ...
            <select onChange={(e) => setItem(e.target.value)} defaultValue="Select Difficulty" className="select dark:text-black">
