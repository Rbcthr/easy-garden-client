...
const ExploreGardeners = () => {
  ...
  return (
    <div className="w-11/12 mx-auto my-16 space-y-5">
      <h2 className="text-3xl font-bold ">Gardeners ({gardeners.length}):</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {gardeners.map((gardener) => (
          <Fade key={gardener?._id} delay={200} duration={1000} fraction={0.5} triggerOnce >
            <div
              
              className="card bg-base-100 shadow-sm hover:shadow-lg hover:shadow-green-300 transition-all duration-500"
            >
              <figure>
                <img src={gardener?.image} className=" w-full" alt="Shoes" />
              </figure>
